...
CPoint::CPoint(Suint32 newx, Suint32 newy)
{
	x = newx;
	y = newy;
}
...
CRect::CRect(Suint32 l, Suint32 t, Suint32 r, Suint32 b) 
{
	left = l;
	top = t;
	right = r;
...
void CRect::SetRect(Suint32 l, Suint32 t, Suint32 r, Suint32 b)
{ 
	left = l; 
	top = t; 
	right = r; 
...
void CString::ReleaseBuffer(Suint32 length)
{
